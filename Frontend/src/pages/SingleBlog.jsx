  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Sticky Back Button */}
        <div className="sticky top-0 z-40 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 pb-3 pt-1">
          <Link
            to="/blogs"
            className="inline-flex items-center gap-2 px-4 py-2.5 text-gray-700 hover:text-teal-600 bg-white/80 hover:bg-white backdrop-blur-sm rounded-lg shadow-sm hover:shadow-md border border-gray-200 transition-all group"
          >
            <IoChevronBackOutline className="text-lg group-hover:-translate-x-1 transition-transform" />
          </Link>
        </div>
